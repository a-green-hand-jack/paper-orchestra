...
* Do not write an author block. The template is loaded with `\usepackage[review]{cvpr}`, which renders "Anonymous CVPR submission" and the paper ID for you. Leave `\author` alone.
